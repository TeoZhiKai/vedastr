                        ...
                        encoder=dict(
                            backbone=dict(
                                ...
                                layers=[
                                    ...
                                    ('pool', dict(type='MaxPool2d', kernel_size=2, stride=2, padding=1)),
                                    ('conv',
                                    ...
                                    ('conv', dict(type='ConvModule', in_channels=256, out_channels=32, kernel_size=1,
                                    ...
                                    ('conv', dict(type='ConvModule', in_channels=512, out_channels=512, kernel_size=1,
                                                  stride=1, padding=1, norm_cfg=norm_cfg)),
                                ],
                            ),
                        ),
