                        ...
                        encoder=dict(
                            backbone=dict(
                                ...
                                layers=[
                                    ...
                                    ('conv', dict(type='ConvModule', in_channels=512, out_channels=256, kernel_size=2,
...
train = dict(
    ...
    resume=dict(checkpoint='D:/FYPtesting/vedastr/vedastr/workdir/small_satrn_modifiedV2/best_acc.pth')                # for continue training from the previous checkpoint
)
